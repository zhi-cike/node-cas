  ...
  var req = https.get({
    ...
    res.on('end', function() {
      ...
      // CAS 2.0 (XML response, and extended attributes)
        ...
        var rootElement = $('cas\\:serviceResponse').first();
        var elemSuccess = rootElement.find('cas\\:authenticationSuccess').first();
        ...
        var elemFailure = rootElement.find('cas\\:authenticationFailure').first();
        ...
        callback(new Error('Bad response format V2.'));
